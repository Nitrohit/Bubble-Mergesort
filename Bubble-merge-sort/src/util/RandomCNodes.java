...
public class RandomCNodes {
  ...
  public static CNode[] randomCNodes(int n) {
    ...
    for (int i = 0; i < arr.length; i++) { //randomizer vores array
  ...
  private static void setCNodeDim(CNode cnode, int n) {
    ...
    cnode.setHeight(((AnimationController.WINDOW_HEIGHT - AnimationController.BUTTONROW_BOUNDARY) / n) * cnode.getValue());
  }
}
